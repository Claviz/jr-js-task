...
const UPDATE_INTERVAL = 1 * 60 * 1000; // 60 seconds

let companyPrice = {};

// request.get inside updateData, using setInterval:

async function updateData(){
    priceData = await request.get(companyPriceURL, (error, response, body) => {
